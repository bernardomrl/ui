...
import { cn as x } from "./index.es47.js";
import { Button as h } from "./index.es9.js";
...
function I({ className: o, ...r }) {
  ...
  return /* @__PURE__ */ l.jsx("div", { ref: t, className: "overflow-hidden", "data-slot": "carousel-content", children: /* @__PURE__ */ l.jsx(
    "div",
    {
      className: x(
        "flex",
